...
class TestWordPressEmailVerification extends WP_UnitTestCase {
	...
	protected $email_verification_key_name = 'testeleven_email_signature';

	public function setUp() {
		$this->email_verifier = new \Testeleven\WordPressEmailVerification\WordPressEmailVerification( $this->email_verification_key_name, 'testeleven' );
	}
	...
	public function test_verify_email_after_login_calls_process_expired_sig_when_sig_is_expired() {
		...
		$wordpress_email_verification_mock = $this
			...
			->setConstructorArgs( [ $this->email_verification_key_name, 'testeleven' ] )
